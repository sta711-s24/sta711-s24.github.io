...
1. Using the code above, verify that -- because all hypotheses are truly null -- both the BH procedure and the Bonferroni procedure control the FWER at level $0.05$.
...
2. Verify that the BH method controls the FDR at level $0.04 = 0.8\cdot 0.05$.

3. Verify that the BH method is more powerful at reject $H_0$ when $H_0$ is false.

4. How does the relative performance of BH and the Bonferroni method change as $m_0$ decreases?
