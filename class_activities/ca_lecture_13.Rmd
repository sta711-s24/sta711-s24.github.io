...
Let $\varepsilon = 0.03$. What fraction of the time do the sample means fall within $\varepsilon$ of the true mean (here $\mu = 0.5$)? That is, what is the empirical estimate of $P(|\bar{X}_n - \mu| \geq 0.5)$?
:::

:::{.question}
#### Question 2

Repeat Question 1 with different values of $n$, and plot the probability as $n$ increases. Verify that the probability approaches 1.
:::
