...
We have demonstrated in class that $I(\beta) = X^T W X$, with $W = \text{diag}(p_i(1 - p_i))$.
...
Repeat the code above many times, calculating the LRT statistic (`m1$null.deviance - m1$deviance`) each time. Use a QQ plot to compare your simulated statistics to a $\chi^2_2$ distribution. Does the $\chi^2_2$ distribution seem like a good approximation?
:::
